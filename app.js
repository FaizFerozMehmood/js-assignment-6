...
document.write("<h1>Printing numbers from 1 to 10</h1>")
for(var i = 1; i<=10;i++){
    document.write(i + "<br>")
}
// Write a loop to print even numbers from 1 to 20.
document.write("<h1>Even number using loop</h1>")
for (var i  = 2; i <=20;i +=2 ){
    document.write(i+"<br>")
}

//• Write a loop to print odd numbers from 1 to 15.
document.write("<h1>ODD number using loop</h1>")
...
document.write("<h1>Square of numbers from 1 to 10</h1>");
